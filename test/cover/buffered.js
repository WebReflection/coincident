import { decode, encode } from '../../dist/buffered.js';
import { minByteLength, maxByteLength } from '../../src/utils.js';

var sab = new SharedArrayBuffer(minByteLength, { maxByteLength: maxByteLength });
...
encode(['loop', 20, new Uint8Array(8), new Date, new RegExp('test', 'gim'), new Error('test', { cause: 'because' })], sab);
console.log(decode(sab));
